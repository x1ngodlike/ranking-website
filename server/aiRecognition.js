...
## 简述要求
1. 列出各场对阵和投注选项（注意"负"表示买客队赢，不是主队输的结果）
2. **关键：对照上方"已结束比赛比分"，逐场判断投注对错（中/错），不要预设中奖**
3. 根据过关方式计算实际中奖情况（区分"最高可能奖金"和"实际兑奖金额"）
4. 风格要求：风趣幽默、抽象搞笑，可以玩梗、吐槽、阴阳怪气，但信息必须准确
5. 严格控制在150字以内
