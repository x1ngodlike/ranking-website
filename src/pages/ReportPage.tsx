...
function Page03FavoriteTeam({ data }: { data: ReportData }) {
  ...
  return (
    <PageContainer>
      ...
      >
        <p className="text-white/60 text-xs mb-3">猜中过的球队</p>
...
function Page04Overview({ data }: { data: ReportData }) {
  const stats = [
...
function Page05PlayType({ data }: { data: ReportData }) {
          ...
          return (
            ...
            >
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className="text-amber-300">{pt.winCount}场</span>
              </div>
...
export default function ReportPage() {
  ...
  const pages = [
    ...
    <Page03FavoriteTeam key="3" data={reportData} />,
    <Page04Overview key="4" data={reportData} />,
    <Page05PlayType key="5" data={reportData} />,
