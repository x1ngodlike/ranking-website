      ...
      >
        ...
        <div className="flex items-center justify-center gap-3 sm:gap-5 md:gap-8 mt-5 md:mt-6">
          ...
          <div className="text-center">
            ...
            <p className={designVersion === 'v2' ? 'font-v2-body text-xs text-[var(--v2-text-secondary)]' : 'text-xs sm:text-sm md:text-sm text-neutral-500 dark:text-neutral-500'}>已赛/剩余</p>
          </div>
          <div className="text-center">
            <p className={
              designVersion === 'v2'
